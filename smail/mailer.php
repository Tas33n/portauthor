    ...
    if ($fileUploaded == 2) {
        ...
        <div class=\"col-md-6 offset-md-3\">
            <div class=\"alert alert-success\" role=\"alert\">
                <strong>Email Sent!</strong> Your spoofed email has been sent using the values seen below. Keep in mind that if you used the rich text editor, the message may appear slightly different in the actual email. Thanks for using SMail by RedThryssa!
            </div>
        </div>
        ";
    }
...
<html>
    <head>
        <meta charset="utf-8">
        <title>SMail | Review your email</title>
        <!-- Bootstrap CSS -->
